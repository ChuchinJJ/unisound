	...
	<div class="copyright_wrap_inner">
		<div class="content_wrap">
			<div class="sc_socials sc_socials_type_icons sc_socials_shape_square sc_socials_size_small">
				...
				<div class="sc_socials_item">
					<a href="https://twitter.com/UnisoundI" target="_blank" class="social_icons social_twitter"><span class="icon-twitter"></span></a>
				</div>
				<div class="sc_socials_item">
				...
				<div class="sc_socials_item">
					<a href="https://youtube.com/channel/UCRjz06O0dtW-0kJWyYZ63-g" target="_blank" class="social_icons social_youtube"><span class="icon-youtube"></span></a>
				</div>
				<div class="sc_socials_item">
					<a href="https://wa.me/529191007549" target="_blank" class="social_icons"><span class="fa fa-whatsapp"></a>
				</div>
			</div>
			<ul id="menu_footer" class="menu_footer_nav">
				<li id="menu-item-794" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-794">
					<a href="/about"><span> Servicios</span></a>
				</li>
				...
				<li id="menu-item-464" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-464">
					<a href="/privacy"><span>Aviso de privacidad</span></a>
				</li>
				<li id="menu-item-464" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-464">
					<a href="/conditions"><span>Términos y condiciones</span></a>
				</li>
				<li id="menu-item-464" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-464">
					<a href="/politica/envios"><span>Política de envíos</span></a>
				</li>
				<li id="menu-item-464" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-464">
					<a href="/politica/devoluciones"><span>Política de devoluciones</span></a>
				</li>
			</ul>
