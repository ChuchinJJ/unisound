            ...
            <form class="card col-md-7 card-register" method="POST" action="{{ route('completar-registro') }}">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-4">
                        ...
                        <input style="font-size:15px;" id="pais" name="pais" type="text" class="form-control" value="{{old('pais')}}" required placeholder="Escriba su país">
                    </div>

                    <div class="col-md-4 mb-4">
                        <label for="estado" class="form-label font-weight-bold letras require-label">Estado</label>
                        <input style="font-size:15px;" id="estado" name="estado" type="text" class="form-control" value="{{old('estado')}}" required placeholder="Escriba su estado">
                    </div>
