        ...
        <div class="row g-0">
            ...
            <div class="col-lg-5 d-flex flex-column align-items-end min-vh-100">
                <div class="px-lg-5 p py-lg-4 p-4 w-100 align-self-center">
                    <h1 class="letras1 mb-4 ">Recupera tu Contraseña :(</h1>
                    <form class="">

                        <div class="mb-4">
                            <label for="exampleInputEmail1" class="form-label font-weight-bold letras ">Email </label>
                            <input style="font-size:15px;" type="email" class="form-control bg-dark-x border-0" id="exampleInputEmail1" required="" placeholder="Ingresa tu correo electronico" aria-describedby="emailHelp">
                        
                        </div>

                        <div class="mb-5 ">
                            <label for="exampleInputPassword1" class="form-label font-weight-bold letras">Nueva Contraseña</label>
                            <input style="font-size:15px;" type="password" class="form-control bg-dark-x border-0 mb-4" required="" placeholder="Ingresa una nueva contraseña" id="exampleInputPassword1">
                        
                        </div>
                        
                        <div class="m-4">
                        <button style="padding: 5px;" type="submit" class="btn w-100 mb-4 ">Recuperar</button>
                        </div>

                    </form>
                        
                    <div class="text-center px-lg-5 pt-lg-3 pb-lg-4 p-4 w-100 m-0">
                        <p class="d-inline-block mb-0 text-p">Regresar a</p> <a class="text-light font-weight-bold text-decoration-none text-a" href="/login">Iniciar Sesión.</a>
                    </div>
