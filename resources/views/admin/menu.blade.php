  ...
  <aside class="main-sidebar sidebar-dark-danger elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image"
        style="background-color: white;border-radius: 100%;padding: 8px;display: flex;color: #343a40; font-size: 20px;">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="pages/widgets.html" class="nav-link" id="ventas">
          ...
          <li class="nav-item">
            <a href="#" class="nav-link" id="productos">
          ...
          <li class="nav-item">
            <a href="pages/calendar.html" class="nav-link" id="clientes">
          ...
          <li class="nav-item">
            <a href="pages/calendar.html" class="nav-link" id="usuarios">
