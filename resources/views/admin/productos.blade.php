      ...
      <div class="container-fluid">
        <div class="row m-3 align-items-center">
          ...
          <div class="col-sm-6 btn-top">
            <a class="btn btn-danger btn-md" href="#">Añadir <i class="fa fa-plus"></i></a>
          </div>
        </div>
      </div>
    </div>
                        ...
                        <table style="border-right: 3px solid white; border-left: 3px solid white;" class="table" width="100%">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td data-label="Rating"><i style="cursor:pointer; " class="fa fa-grin-stars"></i></td>
                                    ...
                                    <td data-label="Detalles"><i class="fa fa-solid fa-angle-down icono-arrow"></i></td>
                                </tr>
                                <tr>
                                    ...
                                    <td data-label="Nombre">Guitarra Electroacustica</td>
                                    <td dara-label="Categoria">De cuerda</td>
                                    <td data-label="Rating"><i style="cursor:pointer; " class="fa fa-sad-cry"></i></td>
