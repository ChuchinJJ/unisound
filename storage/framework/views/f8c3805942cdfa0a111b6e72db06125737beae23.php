        ...
        <div class="row g-0">
            ...
            <div class="col-lg-5 d-flex flex-column align-items-end min-vh-100">
                ...
                <div class="px-lg-5 p py-lg-4 p-4 w-100 align-self-center">
                    <h1 class="letras ">Inicio de Sesión</h1>
                    <form class="">
                        <div class="mb-3">
                            <label  class="form-label font-weight-bold letras ">Usuario </label>
                            <input style="color: rgb(122, 132, 139);" type="text" class="form-control bg-dark-x border-0" id="exampleCheck1" placeholder="Ingresa tu usuario" required="">
                          
                        </div>
                        <div class="mb-3 ">
                            <label for="exampleInputPassword1" class="form-label font-weight-bold letras">Contraseña</label>
                            <input type="password" class="form-control bg-dark-x border-0 mb-3" required="" placeholder="Ingresa tu contraseña" id="exampleInputPassword1">
                            
                            <input type="checkbox" class="form-check-input" id="exampleCheck1">
                            <label style="font-size: 15px;" class="form-check-label letras" for="exampleCheck1">Recordarme</label>
                            <a style="margin-left: 40px; font-size: 16px;" href="/login-contrasena" id="emailHelp" class="form-text text-muted text-decoration-none font-weight-bold ">¡Recuperar contraseña!</a>
                         
                        </div>
                        
                        <button style="padding: 5px;" type="submit" class="btn btn-primary w-100  ">Iniciar Sesión</button>

                    </form>
                        
                    <div class="text-center px-lg-5 pt-lg-3 pb-lg-4 p-4 w-100 m-0">
                        <p class="d-inline-block mb-0 text-p">¿Todavia no tienes una cuenta?</p> <a class="text-light font-weight-bold text-decoration-none" href="/login-registrarse">Crea una ahora!!!</a>
                    </div>
...
<?php echo $__env->make('layouts.container', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\unisound\resources\views/pages/login.blade.php ENDPATH**/ ?>