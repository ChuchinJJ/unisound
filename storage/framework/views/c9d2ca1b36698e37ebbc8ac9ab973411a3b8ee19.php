        ...
        <div class="row g-0">
            ...
            <div class="col-lg-5 d-flex flex-column align-items-end min-vh-100">
                ...
                <div class="px-lg-5 p py-lg-4 p-4 w-100 align-self-center">
                    <h1 class="letras ">Recupera tu Contraseña :(</h1>
                    <form class="">

                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label font-weight-bold letras ">Email </label>
                            <input style="padding: 3px;" type="email" class="form-control bg-dark-x border-0" id="exampleInputEmail1" required="" placeholder="Ingresa tu correo electronico" aria-describedby="emailHelp">
                        
                        </div>

                        <div class="mb-3 ">
                            <label for="exampleInputPassword1" class="form-label font-weight-bold letras">Nueva Contraseña</label>
                            <input style="padding: 3px;" type="password" class="form-control bg-dark-x border-0 mb-2" required="" placeholder="Ingresa una nueva contraseña" id="exampleInputPassword1">
                        
                        </div>
                        
                        <button style="padding: 4px;" type="submit" class="btn btn-primary w-100 m-3 ">Recuperar</button>

                    </form>
                        
                    <div class="text-center px-lg-5 pt-lg-3 pb-lg-4 p-4 w-100 m-0">
                        <p class="d-inline-block mb-0 text-p">Regresar a</p> <a class="text-light font-weight-bold text-decoration-none" href="/login">Iniciar Sesión.</a>
                    </div>
...
<?php echo $__env->make('layouts.container', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\unisound\resources\views/pages/login-contrasena.blade.php ENDPATH**/ ?>