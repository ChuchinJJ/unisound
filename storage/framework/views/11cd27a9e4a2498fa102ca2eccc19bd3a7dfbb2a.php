                    ...
                    <div class="woocommerce">
                        <form name="checkout" method="post" class="checkout woocommerce-checkout" action="/checkout">
                            <div class="row">
                                <div class="col-md-5">
                                    <h2>Tu pedido</h2>
                                    <h3>Factura #<?php echo e($venta->id_venta); ?></h3>
                                    ...
                                    ?>
                                    <h4><?php echo e($fecha); ?></h4>
                                </div>
                                <div class="col-md-7" style="text-align: right;">
                                    <h5><?php echo e($cliente->nombre." ".$cliente->apellidos); ?></h5>
                                    <h4><?php echo e($cliente->calle); ?></h4>
                                    <h4><?php echo e($cliente->ciudad.", ".$cliente->estado.", ".$cliente->pais); ?></h4>
                                    <h4><?php echo e($cliente->email); ?></h4>
                                    <h4><?php echo e($cliente->telefono); ?></h4>
                                </div>
                            </div> 
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="cart_item">
                                            <td class="product-name">
                                                ...
                                                <strong class="product-quantity">&times;&nbsp;<?php echo e($detalle->cantidad); ?></strong>
                                            </td>
                                            <td class="product-total">
                                                <span class="woocommerce-Price-amount amount">
                                                    <bdi><span class="woocommerce-Price-currencySymbol">&#36;</span><?php echo e(number_format($detalle->cantidad*$detalle->precio,2,".",",")); ?></bdi>
                                                </span>
                                            </td>
                                        </tr>
                                    ...
                                    <tfoot>
                                        <tr class="cart-subtotal">
                                            ...
                                            <td><span class="woocommerce-Price-amount amount">
                                                <bdi><span class="woocommerce-Price-currencySymbol">&#36;</span><?php echo e(number_format($venta->total+$venta->descuento,2,".",",")); ?></bdi>
                                            </span></td>
                                        </tr>
                                        <tr class="cart-subtotal">
                                            <th>Descuento</th>
                                            <td><span class="woocommerce-Price-amount amount">
                                                <bdi><span class="woocommerce-Price-currencySymbol">&#36;</span><?php echo e(number_format($venta->descuento,2,".",",")); ?></bdi>
                                            </span></td>
                                        </tr>
                                        <tr class="order-total">
                                            ...
                                            <td>
                                                <strong><span class="woocommerce-Price-amount amount">
                                                    <bdi><span class="woocommerce-Price-currencySymbol">&#36;</span><?php echo e(number_format($venta->total,2,".",",")); ?></bdi>
                                                </span></strong>
                                            </td>
                                        </tr>
                                    </tfoot>
...
<?php echo $__env->make('layouts.container', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\unisound\resources\views/pages/checkout.blade.php ENDPATH**/ ?>