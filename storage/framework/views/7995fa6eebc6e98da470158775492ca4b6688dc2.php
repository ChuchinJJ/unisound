                    ...
                    <div class="card-slider">
                        ...
                        <div class="row">
                            <div class="col-md-7 mb-4">
                                ...
                                <input id="nombre" name="nombre" type="text" class="form-control" required placeholder="Nombre del producto" value="<?php echo e($producto->nombre); ?>" autocomplete="off">
                            </div>
                            <div class="col-md-5 mb-4">
                                <label for="categoria" class="require-label" required>Categoría</label>
                                <select id="categoria" name="categoria" class="form-control" required>
                                    <option value="1" <?php if($categoria == "Cuerda"): ?> selected='selected' <?php endif; ?>>Cuerda</option>
                                    <option value="2" <?php if($categoria == "Percusión"): ?> selected='selected' <?php endif; ?>>Percusión</option>
                                    <option value="3" <?php if($categoria == "Atriles y soporte"): ?> selected='selected' <?php endif; ?>>Atriles y soporte</option>
                                    <option value="4" <?php if($categoria == "Audio"): ?> selected='selected' <?php endif; ?>>Audio</option>
                                    <option value="5" <?php if($categoria == "Iluminación"): ?> selected='selected' <?php endif; ?>>Iluminación</option>
                                    <option value="6" <?php if($categoria == "Adapatadores"): ?> selected='selected' <?php endif; ?>>Adapatadores</option>
                                    <option value="7" <?php if($categoria == "Accesorios"): ?> selected='selected' <?php endif; ?>>Accesorios</option>
                                </select>
                            </div>
                            <div class="col-md-12 mb-4">
                                <label for="desc_general" class="require-label" required>Descripción general</label>
                                <textarea id="desc_general" rows="2" name="desc_general" class="form-control" required placeholder="Descripción general"><?php echo e($producto->descripcion_general); ?></textarea>
                            </div>
                            <div class="col-md-12 mb-4">
                                <label for="desc_detallada" class="require-label" required>Descripción detallada</label>
                                <textarea id="desc_detallada" rows="5" name="desc_detallada" class="form-control" required placeholder="Descripción detallada"><?php echo e($producto->descripcion_detallada); ?></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-slider">
                        ...
                        <div class="row justify-center row-imagenes-product">
                            <div class="col-md-auto mb-2">
                                ...
                                <input type="hidden" name="imagen1" id="imagen1" value="<?php echo e($producto->imagen1); ?>" >
                            </div>
                            <div class="col-md-auto mb-2">
                                ...
                                <input type="hidden" name="imagen2" id="imagen2" value="<?php echo e($producto->imagen2); ?>" >
                            </div>
                            <div class="col-md-auto mb-2">
                                ...
                                <input type="hidden" name="imagen3" id="imagen3" value="<?php echo e($producto->imagen3); ?>" >
                            </div>
                            <div class="col-md-auto mb-2">
                                ...
                                <input type="hidden" name="imagen4" id="imagen4" value="<?php echo e($producto->imagen4); ?>" >
                            </div>
                            <div class="col-md-auto mb-2">
                                ...
                                <input type="hidden" name="imagen5" id="imagen5" value="<?php echo e($producto->imagen5); ?>" >
                            </div>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('admin.container', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\unisound\resources\views/admin/editProduct.blade.php ENDPATH**/ ?>